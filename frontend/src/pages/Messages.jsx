...
export default function Messages() {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-[#F8FAFC]">
      <div className="max-w-[1600px] w-full mx-auto px-4 md:px-6 py-2 md:py-3 flex flex-col flex-1 min-h-0">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-4 flex-shrink-0">
          <div>
            ...
            <h1 className="text-2xl md:text-3xl font-extralight tracking-tighter text-slate-900 mb-1">Message <span className="italic font-serif">Center</span></h1>
              ...
              {filteredConversations.length === 0 ? (
                ...
                filteredConversations.map((conv) => (
                  <motion.div
                    ...
                    className={`w-full p-4 flex items-center gap-3 border-b border-slate-100 hover:bg-white transition-all text-left relative group cursor-pointer ${selectedConversation === conv.email ? 'bg-white border-l-4 border-l-unswap-blue-deep' : 'border-l-4 border-l-transparent'
                      }`}
                    role="button"
                    tabIndex={0}
                  >
                    ...
                    <div className={`w-10 h-10 rounded-none flex items-center justify-center flex-shrink-0 relative transition-transform duration-500 group-hover:scale-105 ${selectedConversation === conv.email ? 'bg-unswap-blue-deep text-white shadow-lg' : 'bg-slate-100 text-slate-400 border border-slate-200'
                      }`}>
          ...
          <div className={`lg:col-span-2 flex flex-col min-h-0 bg-white w-full h-full lg:w-auto ${selectedConversation ? 'flex' : 'hidden lg:flex'}`}>
            {selectedConversation ? (
              <>
                ...
                <div className="p-3 md:p-4 bg-white border-b border-slate-200 flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
                    ...
                    <div className="w-8 h-8 md:w-10 md:h-10 rounded-none bg-unswap-blue-deep/5 flex items-center justify-center border border-unswap-blue-deep/10 flex-shrink-0">
                      <User className="w-4 h-4 md:w-5 md:h-5 text-unswap-blue-deep" />
                    </div>
                    <div className="flex-1 min-w-0">
