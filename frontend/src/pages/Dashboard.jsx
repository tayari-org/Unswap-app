...
import {
  ...
  User, Check, LayoutDashboard, LogOut, Bell, Users as UsersIcon, Copy, TrendingUp
} from 'lucide-react';
              ...
              <>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    ...
                    { label: 'Rating', value: stats.avgRating > 0 ? stats.avgRating.toFixed(1) : '—', icon: Star, color: 'text-amber-600', bg: 'bg-amber-50' },
                ...
                {properties.length > 0 && (
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Link to={createPageUrl('FindProperties')} className="text-sm text-blue-600 hover:text-blue-700 font-medium">
                        Explore More →
                      </Link>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <Card className="border border-stone-100 rounded-2xl shadow-sm bg-white">
                    ...
                    <CardContent className="p-0 pb-2">
                      {[
                        { count: 1, text: '100 bonus GuestPoints', icon: '🎁' },
                        { count: 5, text: 'Lifetime fee waiver', icon: '✨' },
                        { count: 10, text: 'VIP Status', icon: '👑' }
                      ].map((tier, i) => {
                        const achieved = (user?.referral_count || 0) >= tier.count;
                        return (
