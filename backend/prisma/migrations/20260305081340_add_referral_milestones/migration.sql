...
CREATE TABLE "new_User" (
    ...
    "has_sneak_peek" BOOLEAN NOT NULL DEFAULT false,
    "is_founders_circle" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_User" ("avatar_url", "bio", "created_at", "duty_station", "email", "full_name", "google_id", "guest_points", "has_first_year_guarantee", "id", "institution", "institutional_email_verified", "job_title", "languages", "notification_preferences", "password_hash", "phone", "points_escrow", "referral_code", "referral_earnings", "referred_by", "referred_users_verified_count", "reset_password_expires", "reset_password_token", "role", "subscription_plan_id", "subscription_renewal_date", "subscription_status", "swap_preferences", "updated_at", "verification_status") SELECT "avatar_url", "bio", "created_at", "duty_station", "email", "full_name", "google_id", "guest_points", "has_first_year_guarantee", "id", "institution", "institutional_email_verified", "job_title", "languages", "notification_preferences", "password_hash", "phone", "points_escrow", "referral_code", "referral_earnings", "referred_by", "referred_users_verified_count", "reset_password_expires", "reset_password_token", "role", "subscription_plan_id", "subscription_renewal_date", "subscription_status", "swap_preferences", "updated_at", "verification_status" FROM "User";
DROP TABLE "User";
